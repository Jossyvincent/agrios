    ...
    <section className="screen h-screen mb-4 py-20 md:py-28">
      <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
        <div className="grid grid-cols-2 gap-12 items-center">
          ...
          {/* left */}
          <div>
            <p className="text-yellow-500 font-semibold tracking-wider uppercase mb-3 text-center lg:text-left">Frequently asked questions</p>
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-10 text-center lg:text-left">You have any questions</h3>
